...
const DEFAULT_SHARE_ITEMS: ShareItem[] = [
  { icon: SiX, label: "Share on Twitter" },
  { icon: SiInstagram, label: "Share on Instagram" },
  { icon: Share2, label: "Share on LinkedIn" },
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-0 left-1/2 flex h-10 -translate-x-1/2 overflow-hidden"
        transition={{
          duration: 0.3,
          ease: [0.23, 1, 0.32, 1],
        }}
